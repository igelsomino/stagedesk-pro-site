...
const catalog = [
  ...
  { slug: 'don-giovanni', title: 'Don Giovanni', author: 'Lorenzo Da Ponte', subtitle: 'Edizione integrale con note di regia originali', description: 'Il libretto integrale in due atti e trentanove scene, con battute, indicazioni sceniche e note originali per seguire la macchina teatrale e musicale.', actors: 12, acts: 2, scenes: 39, minutes: 180, rights: 'CC BY-SA 3.0 e GFDL · fonte Wikisource', tags: ['Edizione integrale', 'Libretto', 'Note di regia'], package: 'don-giovanni.stagedesk', cover: 'don-giovanni.jpg' },
